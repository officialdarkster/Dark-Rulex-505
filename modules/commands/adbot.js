...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`———»ADMIN BOT«———\n❯ Name: Anup Kumar\n❯ Facebook: https://www.facebook.com/t3ra.b44p.Anup.h3r3\n❯ Thanks for using ${global.config.BOTNAME} bot`,
    ...
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(encodeURI(`https://graph.facebook.com/100009259885163/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
