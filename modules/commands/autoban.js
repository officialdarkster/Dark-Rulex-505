...
module.exports.handleEvent = async ({
	...
	["bot bsdk", "bxdk bot", "bot madharchod", "madharchod bot", "bot mc", "mc bot", "Bot mc", "Bot Mc", "bot teri pen nu", "bot tmkc", "bot gandu", "Bot lun pe", "Anup lol", "bot bkl", "bot mkl", "bot gandu", "Anup bc", "Anup chutiya", "bot chutiya", "bot randi k", "clap bot", "bot ncc", "bot oc", "bot óc", "Anup tmkc", "Anup gandu", "bot tiki", "anup madharchod", "lol bot", "loz bot", "lồn bot", "anup bahenchod", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "Bảo ngu", "bot shoppee", "bad bots", "bot bxdk"].forEach((a => {
