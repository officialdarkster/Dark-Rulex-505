...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["Hi I am Robot made by Dark Rulex", "Please don't disturb me", "Love uhh janeman ;*","Meri Jann Kya Hua","I Love uhh Always","Baby Kaho tO Kiss Kar Lu","Jann aap Mere ho","Date pe chale"];
...
if(input2.includes("haha") || input2.includes("lmao") || input2.includes("lol") || input2.includes("😂") || input2.includes("😹") || input2.includes("🤣") || input2.includes("😆") || input2.includes("😄") || input2.includes("😅") || input2.includes("xd")){
    ...
    if(input2.includes("dead") || input2.includes("sad") || input2.includes("alone") || input2.includes("hate") ||input2.includes("need") || input2.includes("marr") || input2.includes("janaza")){
					        	return api.setMessageReaction("😢", event.messageID, (err) => {}, true)
    }
